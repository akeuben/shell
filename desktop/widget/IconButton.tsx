...
export const IconButton = ({onClicked, icon_name, pixel_size, className, hexpand, vexpand, halign, valign}: {onClicked: () => void, icon_name: string | Accessor<string>, pixel_size: number, className: string | Accessor<string> | undefined, hexpand?: boolean | Accessor<boolean>, vexpand?: boolean | Accessor<boolean>, halign?: Gtk.Align | Accessor<Gtk.Align>, valign?: Gtk.Align | Accessor<Gtk.Align>}) => {
